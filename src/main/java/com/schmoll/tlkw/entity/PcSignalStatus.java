 ...
 */
@TableName(value ="pc_signal_status")
@Data
public class PcSignalStatus implements Serializable {
    /**
     * 唯一ID：自动增长
     */
    ...
    public boolean equals(Object that) {
        ...
        PcSignalStatus other = (PcSignalStatus) that;
    ...
    public PcSignalStatus() {
    }

    public PcSignalStatus(Long id, String signalcode, String signaldes, String signalvalue, Date createtime) {
        this.id = id;
        this.signalcode = signalcode;
        this.signaldes = signaldes;
